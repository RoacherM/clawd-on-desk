...
const i18n = {
  en: {
    ...
    dashboardEmptyHint: "Claude Code, Codex, Hermes, and other agent sessions will appear here.",
  ...
  zh: {
    ...
    dashboardEmptyHint: "Claude Code、Codex、Hermes 和其他 agent 会话会显示在这里。",
  ...
  ko: {
    ...
    dashboardEmptyHint: "Claude Code, Codex, Hermes 및 다른 에이전트 세션이 여기에 표시됩니다.",
